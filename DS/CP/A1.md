...
' 4. Quan hệ
' HoaDon chứa (Composition) 1 Header
HoaDon *-- "1" HoaDonHeader

' HoaDon chứa (Composition) nhiều CTHD
HoaDon *-- "*" CTHD : contains >

' Builder tạo ra HoaDon
HoaDonBuilder ..> HoaDon : <<creates>>

' Builder sử dụng các thành phần để lắp ráp
HoaDonBuilder ..> HoaDonHeader
HoaDonBuilder ..> CTHD

note right of HoaDonBuilder::setHeader
  Trả về 'this' để hỗ trợ
  method chaining (Fluent Interface)
end note

note right of HoaDonBuilder::addChiTiet
  Thêm mới một CTHD vào danh sách
  đang chờ (temp list)
end note
